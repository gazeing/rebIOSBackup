...
+ (void)setUserAgent:(NSString*)value lockToken:(NSInteger)lockToken
{
    ...
    VerboseLog(@"User-Agent set to: %@", value);
     ...
     // added 31/MAR/2014 - Modify the user-agent
    NSLog(@"Original User Agent --> %@",value);
   
    NSString* suffixUA = @" mobileapp";
    NSString* finalUA = [value stringByAppendingString:suffixUA];
    NSLog(@"Modified User Agent --> %@",finalUA);
    ...
    NSDictionary* dict = [[NSDictionary alloc] initWithObjectsAndKeys:finalUA, @"UserAgent", nil];
