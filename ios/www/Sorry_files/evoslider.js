...
// constant
    ...
    var EvoSlider = function ( element, options ) {
        ...
        this.browser = {chrome: false,opera:false,safari:false,msie:false,firefox:false,version:0};
        if(browserVersion.indexOf("Chrome") != -1){
            this.browser.chrome = true;
        } else if(browserVersion.indexOf("Safari") != -1) {
            this.browser.safari = true;
        } else if(browserVersion.indexOf("MSIE 11.0") != -1) {
            this.browser.msie = true;
            this.browser.version = 11;
        }else if(browserVersion.indexOf("MSIE 10.0") != -1) {
            this.browser.msie = true;
            this.browser.version = 10;
        }else if(browserVersion.indexOf("MSIE 9.0") != -1) {
            this.browser.msie = true;
            thisbrowser.version = 9;
        ...
        } else if(browserVersion.indexOf("OPR") != -1) {
    ...
    EvoSlider.prototype = {
        ...
        _createSlider: function() {
            ...
            isOpera = evo.browser.opera ? true : false;
        ...
        _createToggleIcon: function() {
            ...
            ie7 = ( evo.browser.msie && evo.browser.version == 7 ) ? true : false;

            for ( i = 0; i < this._length; i += 1 ){
                if ( !evo.browser.msie || ie7 ) {
        ...
        _resizeOuterControl: function() {
            ...
            if ( !this._options.controlNavVertical ) {
                ...
                cnHeight = this._getHeight( coHeight, this._controlNav, true );            this._controlNav.height( cnHeight );
        ...
        _loadContents: function ( index, max ) {
            var slide, src, cont, fileType, dataLoad, callback, dataUrl, fail,             evo = this, match, id;
